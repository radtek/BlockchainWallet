...
namespace BwCommon.EncryptionDecryption
{
    public static class EncryptDecryptHelper
    {
        ...
        ///// <returns></returns>
        //public static string Md532(Stream stream)
        //{
        ...
        ///// <returns></returns>  
        //public static string EncryptAesStr(this string value, string keyVal, string ivVal)
        //{
        //    if (value == null)
        //    {
        //        throw new ArgumentNullException("未将对象引用设置到对象的实例。");
        ...
        ///// <param name="ivVal">加密辅助向量</param>  
        ///// <returns></returns>  
        //public static string DecryptAesStr(this string value, string keyVal, string ivVal)
        //{
        //    var encoding = Encoding.UTF8;
        //    byte[] btKey = keyVal.FormatByte(encoding);
        //    byte[] btIv = ivVal.FormatByte(encoding);
